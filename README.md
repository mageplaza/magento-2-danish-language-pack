...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/da_dk/da_DK.csv`

See this screenshot

![Danish pack](https://cdn2.mageplaza.com/media/general2/tS668yC.png)
